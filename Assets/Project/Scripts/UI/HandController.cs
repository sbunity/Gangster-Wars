...
namespace SBabchuk
{
    public class HandController : MonoBehaviour
    {
        ...
        public void Init(GrenadesName _grenadeName, GrenadeBttnController _grenade)
        {
            ...
            sRender.sprite = PersistableSO.Instance.BombStore.GetGrenade((int)_grenadeName).ico;
        ...
        public void Checked()
        {
            ...
            PersistableSO.Instance.PlayerPrefs.UseGrenade((int)currentGrenadeName);

            LevelController.Instance.SpawnGrenadeOnPlace(currentGrenadeName, transform.position);
